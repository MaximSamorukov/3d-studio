...
Next.js веб-приложение для продвижения услуг мастерской 3D-печати.
Проект объединяет клиентский интерфейс для пользователей и административную панель, позволяя автоматизировать цикл работы с заказами — от подачи заявки до оплаты.
